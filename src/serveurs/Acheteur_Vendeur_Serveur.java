...
public class Acheteur_Vendeur_Serveur {
	...
	public static void main(String[] args) {
		...
		try {
			...
			objetSystemeEnchere[0] = contexteUtilisateur[0];
			...
			objetSystemeEnchere[1] = new NameComponent(nomObj01,"Objet Utilisateur"); // id, kind

			// Enregistrement de l'ensemble aupres du service de noms
			nameRoot.rebind_context(contexteUtilisateur, nameRoot.new_context());
			nameRoot.rebind(objetSystemeEnchere, rootPOA.servant_to_reference(utilisateur));
