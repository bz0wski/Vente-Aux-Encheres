...
public class _SystemeEnchereStub extends org.omg.CORBA.portable.ObjectImpl implements Enchere.SystemeEnchere
{
  ...
  public void demanderNotificationEnchereEnCours (Enchere.Utilisateur user, Enchere.Produit produit, Enchere.Acheteur_Vendeur ior)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                Enchere.Acheteur_VendeurHelper.write ($out, ior);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                demanderNotificationEnchereEnCours (user, produit, ior        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void creerCompte (String username, String userpswd, String userAdresse)
  {
            ...
            try {
                ...
                creerCompte (username, userpswd, userAdresse        );
            } finally {
                _releaseReply ($in);
            }
  } // creerCompte
  ...
  public void publierProduit (Enchere.Utilisateur vendeur, String nomProduit, String categorieProduit, String descProduit, float prixProduit, String dateProduit)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                publierProduit (vendeur, nomProduit, categorieProduit, descProduit, prixProduit, dateProduit        );
            } finally {
                _releaseReply ($in);
            }
  } // publierProduit
  ...
  public String proposerPrix (float prix, Enchere.Utilisateur user, Enchere.Produit produit)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("proposerPrix", true);
                $out.write_float (prix);
                Enchere.UtilisateurHelper.write ($out, user);
                Enchere.ProduitHelper.write ($out, produit);
                $in = _invoke ($out);
