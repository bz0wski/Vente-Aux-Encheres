...
public class _SystemeEnchereStub extends org.omg.CORBA.portable.ObjectImpl implements Enchere.SystemeEnchere
{
  ...
  public void doneUpdatingClient (Enchere.Acheteur_Vendeur ior)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("doneUpdatingClient", true);
                ...
                doneUpdatingClient (ior        );
            } finally {
                _releaseReply ($in);
            }
  } // doneUpdatingClient

  public Enchere.ClientUpdate[] getUIUpdateStatus ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getUIUpdateStatus", true);
                $in = _invoke ($out);
                Enchere.ClientUpdate $result[] = Enchere.ListeClientUpdateHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getUIUpdateStatus (        );
            } finally {
                _releaseReply ($in);
            }
  } // getUIUpdateStatus

  public boolean addClient (Enchere.ClientUpdate client)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addClient", true);
                Enchere.ClientUpdateHelper.write ($out, client);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
