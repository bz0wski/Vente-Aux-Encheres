 ...
 implements Enchere.SystemeEnchereOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("supprimerVente", new java.lang.Integer (12));
    _methods.put ("enleverVente", new java.lang.Integer (13));
  }
  ...
  /* attribut HashMap qui permet de stocker pour chaque produit la correspondance entre les acheteurs et les prix proposés*/
       case 6:  // Enchere/SystemeEnchere/demanderNotificationEnchereEnCours
       {
         ...
         this.demanderNotificationEnchereEnCours (user, produit, acheteur_VendeurIOR);
         out = $rh.createReply();
         break;
       }
  ...
  /*Cette methode permettra d'enlever une vente terminée de la liste des ventes en cours */
       case 12:  // Enchere/SystemeEnchere/supprimerVente
       {
       ...
       case 13:  // Enchere/SystemeEnchere/enleverVente
       {
