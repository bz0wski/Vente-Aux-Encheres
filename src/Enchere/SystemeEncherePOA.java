 ...
 implements Enchere.SystemeEnchereOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("doneUpdatingClient", new java.lang.Integer (13));
    _methods.put ("getUIUpdateStatus", new java.lang.Integer (14));
    _methods.put ("addClient", new java.lang.Integer (15));
    _methods.put ("proposerPrix", new java.lang.Integer (16));
    _methods.put ("supprimerVente", new java.lang.Integer (17));
    _methods.put ("enleverVente", new java.lang.Integer (18));
    _methods.put ("statistiques", new java.lang.Integer (19));
  }
  ...
  /* attribut HashMap qui permet de stocker pour chaque produit la correspondance entre les acheteurs et les prix proposés*/
       ...
       case 12:  // Enchere/SystemeEnchere/publierProduit
       {
         ...
         Enchere.Produit $result = null;
         $result = this.publierProduit (vendeur, nomProduit, categorieProduit, descProduit, prixProduit, dateProduit, ior);
         out = $rh.createReply();
         Enchere.ProduitHelper.write (out, $result);
         break;
       }


  /* instanciation d'un objet GestionEnchere à la publication d'un nouveau produit*/
       case 13:  // Enchere/SystemeEnchere/doneUpdatingClient
       {
         Enchere.Acheteur_Vendeur ior = Enchere.Acheteur_VendeurHelper.read (in);
         this.doneUpdatingClient (ior);
         out = $rh.createReply();
         break;
       }

       case 14:  // Enchere/SystemeEnchere/getUIUpdateStatus
       {
         Enchere.ClientUpdate $result[] = null;
         $result = this.getUIUpdateStatus ();
         out = $rh.createReply();
         Enchere.ListeClientUpdateHelper.write (out, $result);
         break;
       }

       case 15:  // Enchere/SystemeEnchere/addClient
       {
         Enchere.ClientUpdate client = Enchere.ClientUpdateHelper.read (in);
         boolean $result = false;
       ...
       case 16:  // Enchere/SystemeEnchere/proposerPrix
       {
  ...
  /*Cette methode permettra d'enlever une vente terminée de la liste des ventes en cours */
       case 17:  // Enchere/SystemeEnchere/supprimerVente
       {
       ...
       case 18:  // Enchere/SystemeEnchere/enleverVente
       {
       ...
       case 19:  // Enchere/SystemeEnchere/statistiques
       {
         String $result = null;
         $result = this.statistiques ();
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
